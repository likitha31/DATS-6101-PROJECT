...
Clean_data <- subset(SVI_Data, select = c(ST,STATE,ST_ABBR,STCNTY,COUNTY,FIPS,LOCATION,AREA_SQMI,EPL_POV150,	EPL_UNEMP,	EPL_HBURD,	EP_NOHSDP,	EPL_UNINSUR,	SPL_THEME1,	RPL_THEME1,	EP_AGE65,	EP_AGE17,	EP_DISABL,	EPL_SNGPNT,	EPL_LIMENG,	SPL_THEME2,	RPL_THEME2,	EPL_MINRTY,	SPL_THEME3,	RPL_THEME3,  EP_HISP, EP_ASIAN, EP_AIAN, EPL_MUNIT,	EPL_MOBILE,	EPL_CROWD,	EPL_NOVEH,	EPL_GROUPQ,	SPL_THEME4,	RPL_THEME4,	SPL_THEMES,	RPL_THEMES
) )
...
ggplot(CA_SVI, aes(x = RPL_THEMES, y = RPL_THEME4, color=COUNTY)) +
  ...
  ggtitle("RPL_THEMES VS RPL_THEME4")
...
=======
ggplot(CA_SVI, aes(x = EP_HISP, y = RPL_THEMES, color=COUNTY)) +
>>>>>>> Stashed changes
  geom_point() +
  labs(x = " Percent of Hispanic", y = "RPL_THEMES(Total SVI)") +
...
>>>>>>> Stashed changes
  geom_point() +
  labs(x = "  Percent of the population with no high school diploma", y = "RPL_THEME3( Racial & Ethnic Minority Status)") +
...
=======
ggplot(CA_SVI, aes(x = EP_AGE65, y = RPL_THEME3, color=COUNTY)) +
>>>>>>> Stashed changes
  geom_point() +
  labs(x = "Percent of the population age 65 and older", y = "RPL_THEMES(Total SVI)") +
...
histogram_plot <- ggplot(data = top_10_counties, aes(x = reorder(COUNTY, -mean_SVI), y = mean_SVI)) +
  ...
  labs(x = "County", y = "Mean RPL_THEMES (SVI)", title = "Top 10 Counties with High SVI") +
...
# creating correlation matrix
correlation_matrix <- cor(CA_SVI[, c("EPL_POV150", "EPL_UNEMP", "EPL_HBURD", "EP_NOHSDP", "EPL_UNINSUR","EP_AGE65", "EP_AGE17", "EP_DISABL", "EPL_SNGPNT", "EPL_LIMENG","EPL_MINRTY", "EPL_MUNIT", "EPL_MOBILE", "EPL_CROWD", "EPL_NOVEH","EP_HISP", "EP_ASIAN", "EP_AIAN", "SPL_THEME1", "SPL_THEME2","SPL_THEME3", "SPL_THEME4", "SPL_THEMES","RPL_THEME1", "RPL_THEME2", "RPL_THEME3", "RPL_THEME4")])
