...
# Assuming you have a data frame called 'selected_vars' with columns 'EPL_MINRTY', 'E_AGE65', 'RPL_THEME1'

# Create a bubble plot
ggplot(ca_svi_sf_clean, aes(x = EPL_MINRTY, y = E_AGE65, size = RPL_THEME1)) +
