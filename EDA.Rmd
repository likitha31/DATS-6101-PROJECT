...
\*\*\*\* NOTE: -999 is input for missing data, should we remove the tracts that have -999 in the RPL_THEME1,2,3,4,RPL_THEMES columns?\*\*\*\*\* \*\*\* FOR MAPPING, I HAVE REMOVED THE MISSING DATA\*\*\*
...
```{r}
attach(ca_svi_sf_clean)

scatter3D(CA_SVI$EPL_POV150, CA_SVI$EPL_UNEMP, CA_SVI$EPL_NOHSDP, pch = 20, bty = "g", colkey = TRUE, col.panel ="steelblue", expand =1)

#scatter3D(CA_SVI$EPL_AGE65, CA_SVI$EPL_DISABL, CA_SVI$EPL_UNINSUR, pch = 20, bty = "g", colkey = TRUE, col.panel ="steelblue", expand =1)
