...
Here we can see that there is a large number of missing values, represented by `-999`, but the number of missing values does not equal the number of outliers identified. Thus, for the purposes of our analysis we will remove the missing values, but keep outliers, to identify any particulary at risk census tracts.
