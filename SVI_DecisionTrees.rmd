...
# Assuming you want to predict 'RPL_THEMES' based on 'total_cases' and 'total_deaths'
...
your_data$RPL_THEMES <- as.numeric(your_data$RPL_THEMES)

# Split the data into training and testing sets
set.seed(123)
train_indices <- createDataPartition(your_data$RPL_THEMES, p = 0.7, list = FALSE)
train_data <- your_data[train_indices, ]
test_data <- your_data[-train_indices, ]
