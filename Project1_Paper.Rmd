...
Aggregate the data further by regions of the state so results could be more interpretable
We could also consider spatial autocorrelation of these tracts and their SVI scores to see if there are trends in geographic distribution of types of social vulnerability. Analysis such as hotspots and nearest neighbor could provide powerful visual EDA. 
