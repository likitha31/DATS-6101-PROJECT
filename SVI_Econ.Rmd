...
```{r}
# Assuming your data frame is named 'your_data'
your_data <- predict_svi  # Replace with your actual data frame name

# Create the initial model

initial_model <- lm(RPL_THEMES ~ income + EPL_POV150 + EPL_HBURD + EPL_NOHSDP, data = your_data)
...
tree_model <- rpart(risk ~ ., data = trim_svi, subset = !is.na(risk), method = "class")
...
# Make predictions
tree_predictions <- predict(tree_model, svi_econ, type = "class")

# Add predictions to the dataset
svi_econ$tree_predictions <- tree_predictions
